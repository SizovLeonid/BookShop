...
class Children extends React.Component {
  ...
  ChildrenList() {
    return this.props.childrenBooks.map((book) => {
      return (
  ...
  render() {
    return (
      <div>
        ...
        <BooksCollection collectionName='Childrens literature' collection={this.ChildrenList()}/>
...
function bookStateToProps(state) {
  return {
    childrenBooks: state.childrenBooks,
...
export default connect(bookStateToProps, matchDispatchToProps)(Children);

Children.propTypes = {
  childrenBooks: PropTypes.array.isRequired,
