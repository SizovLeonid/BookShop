...
class Adventure extends React.Component {
  ...
  AdventureList() {
    return this.props.adventureBooks.map((book) => {
      return (
  ...
  render() {
    return (
      <div>
        ...
        <BooksCollection collectionName='Adventure' collection={this.AdventureList()}/>
...
export default connect(bookStateToProps, matchDispatchToProps)(Adventure);

Adventure.propTypes = {
  adventureBooks: PropTypes.array.isRequired,
